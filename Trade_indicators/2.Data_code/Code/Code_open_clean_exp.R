...
data_complete_dummies <- data_combined %>%
  mutate(NAFTA_imp = ifelse(imp %in% c(484, 842, 124), 1, 0),
         UE_imp = ifelse(imp %in% c(40, 56, 58, 100, 191, 196, 203, 
...
save(data_complete_dummies, file = "C:/Users/usuario/Desktop/TFM_R/2.Data_code/data_complete_dummies_exp.rds")
