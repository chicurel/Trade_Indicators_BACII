...
# read in data
imports <- read_csv(paste0("C:/Users/usuario/Desktop/TFM_R/2.Data_code/Output/Imports/", country_code, "_imports.csv"))
...
write_csv(data, paste0("C:/Users/usuario/Desktop/TFM_R/2.Data_code/Output/Data_with_indicators/Imports/", country_code, "_imports_complete.csv"))
}
